...
EPOCH_STEPS="${EPOCH_STEPS:-500000000}" # max epoch 停止训练，step 数开大一点
NUM_EPOCHS="${NUM_EPOCHS:-5}"
NUM_TRAIN_STEPS="${NUM_TRAIN_STEPS:-$((EPOCH_STEPS * NUM_EPOCHS + 1))}"
SAVE_INTERVAL="${SAVE_INTERVAL:-${EPOCH_STEPS}}"
KEEP_PERIOD="${KEEP_PERIOD:-${EPOCH_STEPS}}"

PER_GPU_BATCH_SIZE="${PER_GPU_BATCH_SIZE:-8}"
TOTAL_BATCH_SIZE="${TOTAL_BATCH_SIZE:-$((PER_GPU_BATCH_SIZE * WORLD_SIZE))}"
