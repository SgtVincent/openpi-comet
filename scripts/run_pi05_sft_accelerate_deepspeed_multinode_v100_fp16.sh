...
# Avoid accidentally importing from user-site packages (e.g., ~/.local) which can shadow conda env.
...
echo "Starting OpenPi Accelerate + DeepSpeed ZeRO-${DEEPSPEED_STAGE} training (Multi-Node)"
