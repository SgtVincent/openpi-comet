...
def make_memory_train_config(
    *,
    ...
    return TrainConfig(
        ...
        pytorch_model_name="pi05_subtask",
        model=model,
...
#: Registered configs.  The smoke variant exists so the wiring can be exercised
#: on a couple of episodes without committing a full run.
MOMA_MEMORY_CONFIGS: tuple[TrainConfig, ...] = (
